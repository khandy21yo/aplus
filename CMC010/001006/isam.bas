21000	! ISAM (KEVIN'S BASE; BILL LORTZ' SORT--SEP. 16, 1980) &
	...
	!	    number of records &
	! &
	! MODIFIED MAR 15, 1989 -- KEVIN &
	!	Fixed bug in the FNU(-CH) where it could make the unsorted &
	!	section of the file think it was sorted. &
	! &
	PRINT "Fall through to ISAM!" &
\	STOP &
