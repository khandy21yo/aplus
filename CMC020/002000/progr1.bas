10	  ! &
	  ! Program name: progr1		Compiled with SCALE 0 on V08.0 &
...
2300		  INPUT LINE #PROGRAM.CH%, A$ &
		\ GOTO 2900 IF CVT$$(A$,-1%)="" AND STORE%=-1% &
		\ GOTO 2900 IF LIN% AND VAL(XLATE(SEARCH$,STRING$(48%,0%)+"0123456789"))<VAL(XLATE(LEFT(A$,5%),STRING$(48%,0%)+"0123456789")) AND STORE% AND AUTO% &
