1	%TITLE "Enter Purchases"
	...
	!	and charges from vendors and other related charges into the
	!	Purchases Journal.
	!	.P
	!	Vendor charges which are yet to be paid and/or charges for
	...
	! Compile:
	!
	!	$ BAS AP_SOURCE:AP_MAST_PJ1/LINE
	...
	!		Added AP_MAIN_PJ_H1 to AP_WINDOW.INC.
	!
	...
	!		for a different format of the view.
	!
	!	04/08/99 - Kevin Handy
	!		Use BASIC$STARLET instead of trying to define
...
800	!*******************************************************************
	...
	V% = MAIN_WINDOW(AP_MAIN_PJ_H1.ID, "")
...
20000	FUNCTION LONG MAINT_GROUP(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	EXTERNAL LONG FUNCTION AP_MAIN_PJ_H1
	...
	CASE AP_MAIN_PJ_H1.ID

		MAINT_GROUP = AP_MAIN_PJ_H1(SMG_WINDOW, &
			MOPTION, MLOOP, MFLAG, MVALUE)
