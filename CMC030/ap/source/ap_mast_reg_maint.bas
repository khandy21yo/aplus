1	%TITLE "Accounts Payable Register Maintenance"
	...
	! Compile:
	!
	!	$ BAS AP_SOURCE:AP_MAST_REG_MAINT/LINE
	...
	!		Move menu options from AP_MAIN_OPEN_MAINT to here.
	!--
	%PAGE
...
20000	FUNCTION LONG MAINT_GROUP(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	!	^*Close\*
	!	.p
	!	The ^*Close\* COMMAND accesses the register history file of all accounts
	!	which have been closed. The balance of all accounts which have been closed
	!	must be zero.
	!
	! Index:
	!	.x Closed Register>Maintenance
	!	.x Maintenance>AP Closed Register
	!	.x AP Closed Register>Maintenance
	!	.x Close
	!
	!--
				V% = MAIN_WINDOW(AP_MAIN_CLOSE_MAINT.ID, "")
