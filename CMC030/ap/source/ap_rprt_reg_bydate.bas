1	%TITLE "Accounts Payable Register Report"
	...
	! Compile:
	!
	!	$ BAS AP_SOURCE:AP_RPRT_REG_BYDATE/LINE
	...
	!		Taken from AP_RPRT_REGONEPERIOD
	!
 ...
 Initialization:
	...
	FROM_DATE$ = DATE_STOREDATE(UTL_REPORTX::OPTDEF(6%))
	...
	TO_DATE$ = DATE_STOREDATE(UTL_REPORTX::OPTDEF(7%))
...
17040	WHEN ERROR IN
	...
	GOTO 17040 &
		IF (AP_OPEN::INVDAT < FROM_DATE$) OR &
		(AP_OPEN::INVDAT > TO_DATE$)
