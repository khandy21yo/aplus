1	%TITLE "Accounts Payable General Ledger to Accounts Payable Comparison"
	...
	! Compile:
	!
	!	$ BAS AP_SOURCE:AP_SPEC_GENGL2/LINE
...
18010	TEXT$ = TEST_VENNUM$ + " " + &
	...
	DIFF = FUNC_ROUND(AP_TOTAL - GL_TOTAL, 2%)
	IF (DIFF <> 0.0)
	THEN
		GL_YYYY_PP::ACCT        = AP_OPEN::AP_ACCT
		GL_YYYY_PP::SOURCE      = "PJ"
		GL_YYYY_PP::REFNO       = "FIXUP"
		GL_YYYY_PP::TRANDAT     = "20031201"
		GL_YYYY_PP::DESCR       = AP_VENDOR::VENNAM
		GL_YYYY_PP::AMOUNT      = -DIFF
