1	%TITLE "Accounts Receivable Sales Journal Post Program"
	...
	! Compile:
	!
	!	$ BAS AR_SOURCE:AR_POST_SJ/LINE
	!	$ LINK/EXE=AR_EXE: AR_POST_SJ, FUNC_LIB:CMCLINK/OPTION
	...
	!
	!	08/07/89 - Aaron Redd
	!		Modified to post to SA Balances file.
	!
	!	10/03/89 - Kevin Handy
	!		Modified handling of the description, in an
	!		attempt to remove possibility of null decsription
	!		in the general ledger.
	!
	!	10/20/89 - Frank F. Starman
	!		Change OPT_DETAIL to SUBOPT_DETAIL for function
	!		GL_TRAN_POST. Correct posted description from
	!		journal header to GL transaction file.
	!
	...
	!		Modified to post SUBACCT from AR_SJH.
	!		Was already doing it for lines.
	!		(Special for FJ)
	!
	!	02/09/93 - Kevin Handy
	!		Modified to post DUEDATE and DISCOUNTDATE.
	!
	!	02/25/93 - Kevin Handy
	!		Lost some of the excessive indentations.
	!
	...
	!
	!	05/24/95 - Kevin Handy
	!		Modified so that the "H" types can be used
	!		to generate additional due dates.
	!
	!	06/15/95 - Kevin Handy
	!		Clean up (Check)
	!
	!	07/30/96 - Kevin Handy
	!		Force salesman from the master file.
	!		Reformat sourcde code.
	!
