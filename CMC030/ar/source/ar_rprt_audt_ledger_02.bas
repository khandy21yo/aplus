1	%TITLE "Accounts Receivable Register"
	...
	! Author:
	!
	!	03/01/99 - Kevin Handy
	!		Based on AR_RPRT_AUDT_LEDGER.BAS
	!
	! Compile:
	!
	!	$ BAS AR_SOURCE:AR_RPRT_AUDT_LEDGER_02/LINE
...
17040	!
	...
	GOTO 17040 &
		IF AR_OPEN::TRADAT < FROM_DATE$ OR AR_OPEN::TRADAT > TO_DATE$
...
17060	!
	...
	GOTO 17060 &
		IF AR_CLOSED::TRADAT < FROM_DATE$ OR &
