1	%TITLE "Bill of Materials Control File Maintenance"
	%SBTTL "BM_CNTR_CONTROL"
	%IDENT "V3.6a Calico"
	...
	!	establishs the "Last Purchase Order"
	...
	! Option:
	!
	!	BM_MAIN_CONTROL$HELP
	!
	! Compile:
	!
	!	$ BAS BM_SOURCE:BM_CNTR_CONTROL/LINE
	...
	V% = MAIN_WINDOW(BM_MAIN_CONTROL.ID, "")
...
20000	FUNCTION LONG MAINT_GROUP(CDD_WINDOW_CDD SMG_WINDOW, LONG MOPTION, &
	...
	EXTERNAL LONG	FUNCTION BM_MAIN_CONTROL
	...
	CASE BM_MAIN_CONTROL.ID
		MAINT_GROUP = BM_MAIN_CONTROL(SMG_WINDOW, &
