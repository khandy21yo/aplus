1	%TITLE "Product Cost Structure"
	...
	! Compile:
	!
	!	$ BAS BM_SOURCE:BM_RPRT_LOWCOST/LINE
	!	$ LINK/EXE=BM_EXE: BM_RPRT_LOWCOST, FUNC_LIB:CMCLINK/OPTION
	...
	!		Watch for infinite loops caused by a product
	!		being a component of itself.
	!
	...
	!		Fix report settings screen to match with the
	!		real position of effective date.
	!--
	%PAGE
