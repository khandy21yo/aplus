/*
 *	%TITLE "entr_3message - Display Message And Pause At Bottom Of Screen"
 */
 ...
 * Compile:
 *
 *	$ CC FUNC_SOURCE:entr_3message/G_FLOAT
 ...
 *		(module, smg$routines.h, descriptor)
 *--
 */
  ...
  struct dsc$descriptor_s *mesg, long int *flag)
{
	 ...
	 * Get a real pointer
	 */
/*	scope = scope_desc->dsc$a_pointer; */
