/*
 *	%TITLE "FUNC_SCOSEQ - Convert Entered Characters to Desired Character"
 */
#pragma module func_scoseq "V3.6 Calico"
 ...
 * Compile:
 *
 *	$ CC FUNC_SOURCE:FUNC_SCOSEQ/G_FLOAT
