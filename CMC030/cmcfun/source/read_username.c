/*	%TITLE "Return the Username for the current process."
 */
#pragma module read_username "V3.6 Calico"
 ...
 * Compile:
 *
 *	$ CC/G_FLOAT FUNC_SOURCE:READ_USERNAME
 ...
 * Main function
 */
void read_username(struct dsc$descriptor *returnstr)
{
	/*
	 * Local variables
	 */
	 ...
	 */
	sys_stat = lib$getjpi(&JPI$_USERNAME, &0l, 0l, 0l, &in_val);
