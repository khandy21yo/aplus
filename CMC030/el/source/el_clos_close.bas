1	%TITLE "Equipment Ledger Closing Program"
	%SBTTL "EL_CLOS_CLOSE"
	%IDENT "V3.6a Calico"
	...
	!	.b
	!	.lm +5
	!	The ^*Equipment Ledger Closing Program\*
	!	closes the current period of the equipment ledger.
	!	.lm -5
	!
	! Index:
	!
	...
	! Compile:
	!
	!	$ BAS EL_SOURCE:EL_CLOS_CLOSE/LINE
	!	$ LINK/EXECUTABLE=EL_EXE: EL_CLOS_CLOSE, FUNC_LIB:CMCLINK/OPTION
 ...
 Init:	!==============================================================
	...
	! Title
	!
	TITLE(1%) = "EQUIPMENT  LEDGER  CLOSING  PROTOCOL"
