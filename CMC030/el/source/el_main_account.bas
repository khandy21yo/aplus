1	%TITLE "Equipment Ledger Accounts Maintenance"
	%SBTTL "EL_MAIN_ACCOUNT"
	%IDENT "V3.6a Calico"

	FUNCTION LONG EL_MAIN_ACCOUNT(CDD_WINDOW_CDD SMG_WINDOW, LONG MOPTION, &
	...
	!	.b
	!	.lm +5
	!	The General Ledger Accounts to which the Equipment Ledger
	!	system relates are entered through the ^*Equipment Ledger
	...
	! Compile:
	!
	!	$ BAS EL_SOURCE:EL_MAIN_ACCOUNT/LINE
	...
	!******************************************************************
		...
		! Define SMG_WINDOW
		!
		SMG_WINDOW::DESCR = "EL Accounts"
		SMG_WINDOW::NHELP = "EL_MAIN_ACCOUNT"
		SMG_WINDOW::HSIZE = 70%
		SMG_WINDOW::VSIZE = 4%
		SMG_WINDOW::HPOS  = 4%
		SMG_WINDOW::VPOS  = 11%
		...
		ACCTYPE$(0%) = "2"
		ACCTYPE$(1%) = "NEQP   New Equipment"
		ACCTYPE$(2%) = "UEQP   Used Equipment"
...
20200	CASE OPT_ENTRY
 ...
 ReEnter:	SCOPE::SCOPE_EXIT = 0%
	...
	!	.b
	!	.lm +5
	!	The General Ledger ^*Account Number\* field provides
	!	a number which references the General Ledger Account number.
	!	.lm -5
	!
	! Index:
	!
...
20300	CASE OPT_TESTENTRY
		...
		CASE 2%
			...
			END IF
                        ...
                        EL_MAIN_ACCOUNT = FUNC_TESTENTRY(SMG_WINDOW, &
				SB_ACCOUNT::ACCOUNT, &
				GL_CHART::ACCT, &
				"SB", MLOOP, "PROG", &
