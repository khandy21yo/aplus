1	%TITLE "Equipment Ledger Cost Balances"
	%SBTTL "EL_MAIN_BALANCE"
	%IDENT "V3.6a Calico"

	FUNCTION LONG EL_MAIN_BALANCE(CDD_WINDOW_CDD SMG_WINDOW, LONG MOPTION, &
	...
	!	.b
	!	.lm +5
	!	The history file which shows all past activity and views the
	!	balance for the equipment ledger up to the current date is accessed through
	...
	! Compile:
	!
	!	$ BAS EL_SOURCE:EL_MAIN_BALANCE/LINE
	...
	!******************************************************************
		...
		! Define SMG_WINDOW
		!
		SMG_WINDOW::DESCR = "Equipment Ledger Cost Balances"
		SMG_WINDOW::NHELP = "EL_MAIN_BALANCE"
		SMG_WINDOW::HSIZE = 78%
		SMG_WINDOW::VSIZE = 18%
		SMG_WINDOW::HPOS  = 2%
		SMG_WINDOW::VPOS  = 2%
...
20200	CASE OPT_ENTRY
 ...
 ReEnter:	SCOPE::SCOPE_EXIT = 0%
	...
	!	.b
	!	.lm +5
	!	The ^*Equipment Number\* field enters a number
	!	which will reference a particular piece of equipment.
	!	.b
	...
	!--
			...
			THEN
				IF MAIN_WINDOW(EL_MAIN_EQUIPMENT.ID, "VX") = 1%
				THEN
					SB_BALANCE::SUBACCOUNT = &
	...
	!	.b
	!	.lm +5
	!	The ^*Operation\* field enters a code which identifies
	...
	!	in this account for the equipment number entered.
	!	.lm -5
	!
	! Index:
	!	.x Account
	...
	!	Ledger Account for the current period and equipment number specified.
	!	.lm -5
	!
	! Index:
	!	.x Amount
	...
	!	general ledger account and equipment number at the beginning of the period.
	!	.lm -5
	!
	! Index:
	!	.x Beginning Amount
...
20300	CASE OPT_TESTENTRY
		...
		CASE 1%
			...
			THEN
				...
				!
				EL_MAIN_BALANCE = FUNC_TESTENTRY(SMG_WINDOW, &
					"E" + SB_BALANCE::SUBACCOUNT, &
					SB_SUBACCOUNT::SUBACCOUNT, &
					"EL", MLOOP, "SUBACCOUNT", &
					"Equipment number", &
					EL_MAIN_EQUIPMENT.ID)
	...
	CASE OPT_DISPLAY
		...
		THEN
			SB_SUBACCOUNT::DESCR = &
				...
				IF MAIN_WINDOW(EL_MAIN_EQUIPMENT.ID, "Q0" + &
				"E" + SB_BALANCE::SUBACCOUNT) <> 1%
