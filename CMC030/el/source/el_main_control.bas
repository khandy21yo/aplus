1	%TITLE "Equipment Ledger Controlling File"
	%SBTTL "EL_MAIN_CONTROL"
	%IDENT "V3.6a Calico"

	FUNCTION LONG EL_MAIN_CONTROL(CDD_WINDOW_CDD SMG_WINDOW, LONG MOPTION, &
	...
	!	the ^*Equipment Ledger Controlling File\*.
	!	.lm -5
	!
	! Index:
	!
	...
	! Compile:
	!
	!	$ BAS EL_SOURCE:EL_MAIN_CONTROL/LINE
	...
	CASE OPT_INIT
		...
		! Define SMG_WINDOW
		!
		SMG_WINDOW::DESCR = "Equipment Ledger Controlling File"
		SMG_WINDOW::NHELP = "EL_MAIN_CONTROL"
		SMG_WINDOW::HSIZE = 78%
		SMG_WINDOW::VSIZE = 18%
		SMG_WINDOW::HPOS  = 2%
		SMG_WINDOW::VPOS  = 2%
