	!======================================================================
	! IC_TRANSACTION file (open read/write)
	!======================================================================
	...
	OPEN IC_TRANSACTION.NAME$ FOR INPUT AS FILE IC_TRANSACTION.CH%, &
