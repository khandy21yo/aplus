1	%TITLE "Location Balances"
	...
	! Compile:
	!
	!	$ BAS IC_SOURCE:IC_RPRT_COUNTSHEET_KBJ/LINE
	!	$ LINK/EXE=IC_EXE: IC_RPRT_COUNTSHEET_KBJ, FUNC_LIB:CMCLINK/OPTION
	!	$ DELETE IC_RPRT_COUNTSHEET_KBJ.OBJ;*
	!
	! Author:
	!
	!	08/24/2001 - Kevin Handy
	!		Based on IC_RPRT_LOCATIONBAL
	!
