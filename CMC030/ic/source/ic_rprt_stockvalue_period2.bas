1	%TITLE "Stock Value Report"
	%SBTTL "IC_RPRT_STOCKVALUE_PERIOD2"
	%IDENT "V3.6a Calico"
	...
	! Compile:
	!
	!	$ BAS IC_SOURCE:IC_RPRT_STOCKVALUE_PERIOD2/LINE
	!	$ LINK/EXE=IC_EXE: IC_RPRT_STOCKVALUE_PERIOD2, FUNC_LIB:CMCLINK/OPTION
	!	$ DELETE IC_RPRT_STOCKVALUE_PERIOD2.OBJ;*
	!
	! Author:
	!
	!	04/28/2000 - Kevin Handy
	!		Based on IC_RPRT_STOCKVALUE_PERIOD report
	!
	! Modification History:
	!
	!	03/29/2004 - Kevin Handy
	!		Add option for active/inactive
	!--
 ...
 Init:	!
	...
	ACTIVE$ = LEFT$(UTL_REPORTX::OPTDEF(5%), 1%)
...
17300
	...
	EXTCOST2 = FUNC_ROUND(COST * BEGBAL, 2%)
	...
	TOTAL2_COST = TOTAL2_COST + EXTCOST2
	SUBTOTAL_COST = SUBTOTAL_COST + EXTCOST
	SUBTOTAL2_COST = SUBTOTAL2_COST + EXTCOST2
