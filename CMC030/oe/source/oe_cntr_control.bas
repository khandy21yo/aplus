1	%TITLE "Controlling File"
	...
	!	the last close/purge date,
	!	the status flag which indicates the current activity
	!	of the Order Entry system, last credit memo number, last invoice number,
	!	and the backorder aging dates and titles.
	!	.b
	...
	! Option:
	!
	!	OE_MAIN_CONTROL$HELP
	!
	! Compile:
	!
	!	$ BAS OE_SOURCE:OE_CNTR_CONTROL/LINE
	...
	V% = MAIN_WINDOW(OE_MAIN_CONTROL.ID, "")
...
20000	FUNCTION LONG MAINT_GROUP(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	EXTERNAL LONG FUNCTION OE_MAIN_CONTROL
	...
	CASE OE_MAIN_CONTROL.ID

		MAINT_GROUP = OE_MAIN_CONTROL(SMG_WINDOW, &
