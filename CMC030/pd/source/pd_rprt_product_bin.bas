1	%TITLE "Product Description List"
	...
	! Compile:
	!
	!	$ BAS PD_SOURCE:PD_RPRT_PRODUCT_BIN/LINE
	!	$ LINK/EXE=PD_EXE: PD_RPRT_PRODUCT_BIN, FUNC_LIB:CMCLINK/OPTION
	!	$ DELETE PD_RPRT_PRODUCT_BIN.OBJ;*
	!
	! Author:
	!
	!	10/26/99 - Kevin Handy
	!
 ...
 Init:	! Initilize report
	...
	!	.b
	!	.lm +5
	!	Specifies which Location to include.
	!	.lm -5
	!
	! Index:
	!	.x Product Description List>Form Type
