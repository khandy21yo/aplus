1	%TITLE "Customer Name/Address Mailmerge Program"
	...
	! Author:
	!
	!	05/29/2008 - Kevin Handy
	!		Based on AR_SPEC_MAILCOMMA
	!
	! Compile:
	!
	!	$ BAS PP_SOURCE:PP_SPEC_MAILCOMMA/LINE
...
320	!
 ...
 ReportTitle:
	...
	! Title
	!
	TITLE$(1%) = "Pacific Pride MailMerge File Creation"
	TITLE$(2%) = ""

	!
	! Display Heading
	!
	TITLE$(3%) = "Number of customers"
	TITLE$(4%) = ""
...
17020	!
	...
	!
	! If he doesn't appear in the card file, ignore him
	!
	WHEN ERROR IN
		GET #PP_CARD.CH%, KEY #0% EQ AR_35CUSTOM::CUSNUM, REGARDLESS
	USE
		CONTINUE 17020
	END WHEN
