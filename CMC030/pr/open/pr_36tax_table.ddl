DEFINE RECORD CDD$TOP.PR.PR_36TAX_TABLE

        DESCRIPTION IS /*Payroll Tax Table*/.

        PR_36TAX_TABLE_CDD STRUCTURE.
        ...
        FICA_EMPR_PCT           DATATYPE IS G_FLOATING.

        /* Element =
        Description = Employee FICA percent OASDI */
        FICA_EMPE_PCT           DATATYPE IS G_FLOATING.
        ...
        FICA_EMPR_PCT_HI        DATATYPE IS G_FLOATING.

        /* Element =
        Description = Employee FICA HI percentage */
        FICA_EMPE_PCT_HI        DATATYPE IS G_FLOATING.
        ...
        THRESHOLD               DATATYPE IS G_FLOATING.

        /* Element =
        Description = Federal Exemption Threshold Rate */
        THRESHOLD_RATE          DATATYPE IS G_FLOATING.
        ...
        END PR_36TAX_TABLE_CDD STRUCTURE.
