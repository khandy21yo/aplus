1	%TITLE "CHECK - Print Payroll Checks"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_FORM_CHECK_DIRDEP
	...
	MAP (PR_FORM_CHECK_DIRDEP_STUFF) &
		ERN_LOOP%, &
		TAX_LOOP%, &
		DED_LOOP%, &
		NON_LOOP%, &
...
400	!
	...
	LAST_CKNUM$ = TRM$(UTL_REPORTX::OPTDEF(0%))
	...
	REPORT$ = "PRCHK" + "$" + TRM$(UTL_REPORTX::OPTDEF(9%))
	!++
	! Abstract:FLD10
	!	^*(10) Form Name\*
	!	.b
...
18380	PR_TRN_CHECK::CHECK = LAST_CKNUM$
