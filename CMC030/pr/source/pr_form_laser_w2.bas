1	%TITLE "Print Payroll W2 Form"
	...
	!
	! Option:
	!	PR_FORM_LASER_W2$CONFIRM
	!
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_FORM_LASER_W2
	...
	! Author:
	!
	!	01/22/2007 - Kevin Handy
	!		Based on PR_FORM_W2, modified to work better
	!		on laser printers.
	!
	! Modification history:
	!
	!	01/29/2007 - Kevin Handy
	!		Add TOLOCAL and TOSCOPE print on OUTP_FORMFF.
	!--
