1	%TITLE "TimeKeeper Maintenance"
	%SBTTL "PR_JOUR_TIMKEP_03"
	%IDENT "V3.6a Calico"
	...
	!	These journals provide the means to enter hours worked or hours to be
	!	paid, as well as payments or earnings unrelated to time (such as
	!	bonuses, commissions, etc.), non-standard deductions and after-the-fact
	!	manual pay-off data.
	!	.lm -5
	!
	! Index:
	...
	! Option:
	!
	!	PR_JOUR_TIMKEP_03$LOACTION
	!	PR_MAIN_TRN_TK03_PAY$HELP
	!	PR_MAIN_TRN_TK03_DED$HELP
	!	PR_MAIN_TRN_TK03_CHECK$HELP
	!
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_JOUR_TIMKEP_03/LINE
	...
	!		Added Deduction and Check screen to program
	!
...
340	!
	...
	SMG_STATUS% = SMG$PUT_CHARS(SMG_SCREEN_DATA%, &
		PRNT_DATE(BATCH_NO$, 8%), 6%, 45%, , SMG$M_BOLD)

	SMG_STATUS% = SMG$PUT_CHARS(SMG_SCREEN_DATA%, &
		"(02) Payroll End Date", 8%, 20%)
...
390	!
	...
	V% = MAIN_JOURNAL(PR_MAIN_TRN_TK03_PAY.ID, "")
...
20000	FUNCTION LONG MAINT_GROUP(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	EXTERNAL LONG FUNCTION PR_MAIN_TRN_TK03_PAY
	...
	! Pay File
	!
	CASE PR_MAIN_TRN_TK03_PAY.ID

		MAINT_GROUP = PR_MAIN_TRN_TK03_PAY(SMG_WINDOW, &
			MOPTION, MLOOP, MFLAG, MVALUE)
