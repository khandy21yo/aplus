1	%TITLE "Employee Master File Maintenance"
	%SBTTL "PR_MAIN_DETAIL_EMP_QUERY"
	%IDENT "V3.6a Calico"

	FUNCTION LONG PR_MAIN_DETAIL_EMP_QUERY(CDD_WINDOW_CDD SMG_WINDOW, &
		LONG MOPTION, &
	...
	! Option:
	!
	!	PR_MAIN_DETAIL_EMP_QUERY$PAY
	!	PR_MAIN_DETAIL_EMP_QUERY$DED
	!	PR_MAIN_DETAIL_EMP_QUERY$CHECK
	!
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_MAIN_DETAIL_EMP_QUERY/LINE
	...
	!		Display payroll date on title bar
	!--
	%PAGE
	...
	CASE OPT_INIT
		...
		SMG_WINDOW::NHELP = "PR_MAIN_DETAIL_EMP_QUERY"
...
20100	CASE OPT_BACKGROUND
	...
	CASE OPT_MOREMENU
		...
		!
		CASE "PAY"
			PR_MAIN_DETAIL_EMP_QUERY = &
				MAIN_JOURNAL(PR_MAIN_TRN_PAY.ID, "")
	...
	CASE OPT_AFTEROPT
		...
		CASE "Erase"
			...
			!
			PR_MAIN_DETAIL_EMP_QUERY = &
				MAIN_JOURNAL(PR_MAIN_TRN_PAY.ID, "E")
			PR_MAIN_DETAIL_EMP_QUERY = &
...
20200	CASE OPT_ENTRY
 ...
 E0Loop:	SELECT MLOOP
	...
	!	.b
	!	.lm +5
	!	The employee's nine (9) digit social security number is entered
	!	in the ^*Social Security Number\* field with the associated
	!	dashes.
	!	.lm -5
	!
	! Index:
