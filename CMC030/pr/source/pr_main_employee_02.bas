1	%TITLE "Employee Master File Maintenance"
	%SBTTL "PR_MAIN_EMPLOYEE_02"
	%IDENT "V3.6a Calico"

	FUNCTION LONG PR_MAIN_EMPLOYEE_02(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_MAIN_EMPLOYEE_02/LINE
	...
	!		Adjusted view so that all 10 characters in the
	!		employee number were visible.
	!
	!	10/25/90 - Kevin Handy
	!		Added rate type 'X' (eXcess).
	!
	!	11/07/90 - Val Allen
	!		added field active flag to 2nd page
	!
	!	07/13/91 - Kevin Handy
	!		Fixed undefined structure errors for
	!		PR_OPEN, PR_UNPN_DESC and PR_WC_DESCR.
	!
	...
	!		Added "N Native american" and "A Asian"
	!		codes.
	!
	...
	CASE OPT_INIT
		...
		SMG_WINDOW::NHELP = "PR_MAIN_EMPLOYEE_02"
...
20100	CASE OPT_BACKGROUND
	...
	!--
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_STATUS.ID, "")
	...
	!	.p
	!	The ^*Rate\* function
	!	accesss the field where an employee's pay rate(s) are recorded. All rates
	...
	!--
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_RATE_02.ID, "")
	...
	!	^*Pay-ernded\*
	!	.p
	!	The ^*Pay-erned\* function
	!	provides access to the file where standard benefit accruals, payments, and
	...
	!--
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_STD_ERNDED.ID, "")
	...
	!--
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_ACCRUAL.ID, "")
	...
	!	^*Chronicle\*
	!	.p
	!	The ^*Chronicle\* option accesses the employee work history. Such
	!	events as hire date, termination date, leave of absence, vacation, etc.
	...
	!--
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_DATES.ID, "")
	...
	CASE OPT_AFTEROPT
		...
		CASE "Add"
			...
			!
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_STATUS.ID, "A")
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_RATE_02.ID, "A")
		...
		CASE "Erase"
			...
			!
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_STATUS.ID, "E")
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_RATE_02.ID, "E")
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_STD_ERNDED.ID, "E")
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_ACCRUAL.ID, "E")
			PR_MAIN_EMPLOYEE_02 = &
				MAIN_JOURNAL(PR_MAIN_EMP_DATES.ID, "E")
...
20200	CASE OPT_ENTRY
 ...
 E0Loop:	SCOPE::SCOPE_EXIT = 0%
	...
	!	^*(15) Re_-hire\*
	!	.p
	!	The ^*Re_-hire\* field records that when an employee
	...
	!--
			...
			PR_EMP_MASTER::REHIRE_FLAG = ENTR_3YESNO(SCOPE, &
				...
				PR_EMP_MASTER::REHIRE_FLAG, MFLAG, "'E", MVALUE)
	...
	!	^*(17) Race\*
	!	.p
	!	The ^*Race\* field is a one character user defined code.  If the user
	!	has no specific requirement for recording race, this field may be left
	!	blank.
	!
	! Index:
	!	.x Employee>Race
	...
	!	^*(22) Subacct\*
	!	.p
	!	The ^*Subacct\* field records a default subaccount
	...
	!	.x GL Account Number>Employee
	!	.x Account Number>Employee
	!
	!--
	...
	!	^*(24) Trade\*
	!	.p
	!	The ^*Trade\* field is a six (6) character user defined field whioh contains
	!	a specific trade if the employee has such a skill.
	!
	! Index:
	!	.x Employee>Trade
	!	.x Trade>Employee
	...
	!	belongs.
	!	.p
	!	If this field is not applicable, it may be left blank.
	!
	! Index:
	!	.x Employee>Union
	!	.x Union>Employee
	...
	!--
			...
			IF (SCOPE::SCOPE_EXIT = SMG$K_TRM_F14)
			THEN
				IF (MAIN_WINDOW(PR_MAIN_UNPN_DESC.ID, &
					"VX ") = 1%)
				THEN
					PR_EMP_MASTER::UNION = &
						PR_UNPN_DESC::CODE
	...
	!--
			...
			PR_EMP_MASTER::LOCATION = ENTR_3STRING(SCOPE, &
				...
				PR_EMP_MASTER::LOCATION, MFLAG, "'E", MVALUE)
	...
	!	^*(30) Employee Skill\*
	!	.p
	!	The ^*Employee Skill\* field enters a three
	!	(3) character user defined code which identifies a particular job
	...
	!	subject to State Unemployment tax.
	!
	! Index:
	...
	!	enters a default package number or mnemonic designation
	...
	!	combination of jurisdictions, including different States, different
	!	cities, etc.
	!	.p
	...
	!	^*(35) 1099\*
	!	.p
	!	The ^*1099\* field contains a ^*Y\* flag if an non-employee
	!	individual is added to the Employee Master file.  The ^*Y\* flag
	!	indicates that the individual is not an employee, though paid
	!	through the Payroll System, and that a Form 1099 will be prepared
	!	for the individual at year end rather than a W-2 Form.
	!	.p
	!	The field will default to an ^*No\* flag (for no) by pressing
	!	^*<Do>\* without entering any value while the cursor is located
	!	at this field.
	!
	! Index:
	!	.x Employee>1099
	...
	!--
			...
			PR_EMP_MASTER::W2_1099 = ENTR_3YESNO(SCOPE, &
				SMG_WINDOW::LWINDOW, "5;60", TEMP$, &
				PR_EMP_MASTER::W2_1099, MFLAG, "'E", MVALUE)
	...
	!++
	! Abstract:FLD038
	!	^*(38) Workmens Compensation\*
	!	.p
	!	The ^*Workmens Compensation\* field enters a default
	...
	!--
			...
			IF (SCOPE::SCOPE_EXIT = SMG$K_TRM_F14)
			THEN
				IF (MAIN_WINDOW(PR_MAIN_WC_DESCR.ID, &
					"VX ") = 1%)
				THEN
					PR_EMP_MASTER::WC = &
						PR_WC_DESCR::CODE
			...
			ELSE
				...
				ELSE
					...
					THEN
						...
						CALL ENTR_3MESSAGE(SCOPE, &
			"Employee is active.  Change of empl # not allowed", 0%)
					END IF
				END IF
			END IF
...
20310			IF (MVALUE = "ADD") AND NOT (PR_EMP_MASTER::SSN = "")
		...
		CASE 23%
			...
			!
			PR_MAIN_EMPLOYEE_02 = FUNC_TESTENTRY(SMG_WINDOW, &
				PR_EMP_MASTER::ACCT, &
				GL_CHART::DESCR, &
				"PR", MLOOP, "PRG", &
		...
		CASE 38%
			...
			THEN
				...
				PR_MAIN_EMPLOYEE_02 = FUNC_TESTENTRY(SMG_WINDOW, &
					...
					PR_WC_DESCR::DESCR, &
					"PR", MLOOP, "PRG", &
					"Workmen Comp", PR_MAIN_WC_DESC.ID)
			END IF
