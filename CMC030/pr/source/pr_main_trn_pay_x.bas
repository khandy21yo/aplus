1	%TITLE "PR Pay Journal Maintenance"
	%SBTTL "PR_MAIN_TRN_PAY_X"
	%IDENT "V3.6a Calico"

	FUNCTION LONG PR_MAIN_TRN_PAY_X(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_MAIN_TRN_PAY_X/LINE
	...
	!		Zero out batch number in new records.
	!
	...
	CASE OPT_INIT
		...
		SMG_WINDOW::NHELP = "PR_MAIN_TRN_PAY_X"
		SMG_WINDOW::HSIZE = 78%
		SMG_WINDOW::VSIZE = 14%
		SMG_WINDOW::HPOS  = 2%
		SMG_WINDOW::VPOS  = 6%
...
20200	CASE OPT_ENTRY
 ...
 !		CASE 21%
	...
	!	^*(01) Payroll End Date\*
	!	.p
	!	The ^*Payroll End Date\* field in a Payroll Register record refers
	...
	!	^*(02) Employee Skill\*
	!	.p
	!	The ^*Employee Skill\* field in a Payroll Register record refers
	...
	!	^*(03) Employee Grade\*
	!	.p
	!	The ^*Employee Grade\* field in a Payroll Register record refers
	...
	!	^* (04) Union\*
	!	.p
	!	The ^*Union\* field in a Payroll Register record refers to the
	...
	!	^*(05) Location\*
	!	.p
	!	The ^*Location\* field in a Payroll Register record refers to
	...
	!	^*(06) Department\*
	!	.p
	!	The ^*Department\* field of a Payroll Register record refers to the
	...
	!	^*(07) Work Center\*
	!	.p
	!	The ^*Work Center\* field in a Payroll Register record refers to
	...
	!	^*(08) Account\*
	!	.p
	!	The ^*Account\* field in a Payroll Register record refers to the
 ...
 E0Loop1:		XLINE$ = NUM1$(SMG_WINDOW::CURLIN + 8%)
	...
	!	^*(09) Sub Account\*
	!	.p
	!	The ^*Sub Account\* field in a Payroll Register record refers to
	...
	!	^*(10) Operation\*
	!	.p
	!	The ^*Operation\* field in a Payroll Register record refers to
	...
	!	^*(11) Pay Code\*
	!	.p
	!	The ^*Pay Code\* field in a Payroll Register record refers to the
 ...
 E0Loop2:		XLINE$ = NUM1$(SMG_WINDOW::CURLIN + 11%)
	...
	!	^*(12) Tax Package Code\*
	!	.p
	!	The ^*Tax Package Code\* field in a Payroll Register record refers
 ...
 E0Loop3:		XLINE$ = NUM1$(SMG_WINDOW::CURLIN + 12%)
	...
	!	^*(13) Pay Type\*
	!	.p
	!	The ^*Pay Type\* field in a Payroll Register record refers to the
	...
	!	^*(14) Rate Type\*
	!	.p
	!	The ^*Rate Type\* field in a Payroll Register record refers to the
	...
	!	^*(15) Hourly Rate\*
	!	.p
	!	The ^*Hourly Rate\* field in a Payroll Register record refers to the
	...
	!	^*(16) Overtime Factor\*
	!	.p
	!	The ^*Overtime Factor\* field in a Payroll Register record refers to
	...
	!	^*(17) Unit Rate\*
	!	.p
	!	The ^*Unit Rate\* field in a Payroll Register record refers to the
	...
	!	^*(18) Regular Hours\*
	!	.p
	!	The ^*Regular Hours\* field in a Payroll Register record refers to
	...
	!	^*(19) Overtime Hours\*
	!	.p
	!	The ^*Overtime Hours\* field in a Payroll Register record refers to
	...
	!	^*(20) Number of Units\*
	!	.p
	!	The ^*Number of Units\* in a Payroll Register record refers to pieces
...
20300	CASE OPT_TESTENTRY
		...
		CASE 8%
			...
			!
			PR_MAIN_TRN_PAY_X = FUNC_TESTENTRY(SMG_WINDOW, &
				PR_TRN_PAY::ACCT, &
				GL_CHART::DESCR, &
				"PR", MLOOP, "PRG", &
