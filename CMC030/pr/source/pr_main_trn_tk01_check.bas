1	%TITLE "PR Check Time Keeper Journal Maintenance"
	%SBTTL "PR_MAIN_TRN_TK01_CHECK"
	%IDENT "V3.6a Calico"

	FUNCTION LONG PR_MAIN_TRN_TK01_CHECK(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	!	.p
	!	A record for an employee in the Check Journal will preclude a
	!	check being written for the subject employee during the execution of
	!	the payroll check printing routine.
	!
	! Index:
	!	.x Functions>checK
	!	.x Check>Function
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_MAIN_TRN_TK01_CHECK/LINE
	...
	CASE OPT_INIT
		...
		SMG_WINDOW::NHELP = "PR_MAIN_TRN_TK01_CHECK"
...
20100	CASE OPT_BACKGROUND
		...
		SMG_STATUS% = SMG$PUT_CHARS(SMG_WINDOW::WNUMBER, &
			"  (01)                                              " + &
			"(02)       (03)                    " + &
			SPACE$(45%), 1%, 1%, , SMG$M_REVERSE)
		SMG_STATUS% = SMG$PUT_CHARS(SMG_WINDOW::WNUMBER, &
			"  Emp #          Employee Name                      " + &
			"Check#     Check Date              " + &
			SPACE$(52%), 2%, 1%, , SMG$M_REVERSE)
	...
	CASE OPT_DISPLAY
		...
		!
		FOR I% = 1% TO 4%
			A% = VAL%(MID("015,050,061,076", I% * 4% - 3%, 3%))
...
20200	CASE OPT_ENTRY
 ...
 E0Loop:	SCOPE::SCOPE_EXIT = 0%
	...
	!
	! Index:
	!	.x End Date>Timekeeper>Check
	!	.x Timekeeper>Check>End Date
...
20300	CASE OPT_TESTENTRY
		TEMP_FLAG%, PR_MAIN_TRN_TK01_CHECK = 0%
		...
		CASE 1%
			...
			!
			PR_MAIN_TRN_TK01_CHECK = FUNC_TESTENTRY(SMG_WINDOW, &
				PR_TRN_CHECK::EMPNUM, &
			...
			THEN
				...
				THEN
					...
					!
					TEMP_FLAG%, PR_MAIN_TRN_TK01_CHECK = 1%
