1	%TITLE "Deduction Journal Worksheet"
	%SBTTL "PR_MAIN_TRN_TK02_DED"
	%IDENT "V3.6a Calico"

	FUNCTION LONG PR_MAIN_TRN_TK02_DED(CDD_WINDOW_CDD SMG_WINDOW, &
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_MAIN_TRN_TK02_DED/LINE
	...
	!		Taken from PR_TRN_TK01_DED, set up for 80 columns.
	!
	...
	CASE OPT_INIT
		...
		SMG_WINDOW::NHELP = "PR_MAIN_TRN_TK02_DED"
		SMG_WINDOW::HSIZE = 78%
		SMG_WINDOW::VSIZE = 18%
		SMG_WINDOW::HPOS  = 2%
		SMG_WINDOW::VPOS  = 2%
...
20100	CASE OPT_BACKGROUND
	...
	CASE OPT_DISPLAY
		...
		!
		FOR I% = 1% TO 5%
			A% = VAL%(MID("013,037,043,050,067", I% * 4% - 3%, 3%))
...
20300	CASE OPT_TESTENTRY
		TEMP_FLAG%, PR_MAIN_TRN_TK02_DED = 0%
		...
		CASE 1%
			...
			!
			PR_MAIN_TRN_TK02_DED = FUNC_TESTENTRY(SMG_WINDOW, &
				PR_TRN_DED::EMPNUM, &
			...
			SMG_STATUS% = SMG$PUT_CHARS(SMG_WINDOW::WNUMBER, &
				...
				SMG_WINDOW::CURLIN, 15%,, SMG$M_BOLD)
			...
			THEN
				...
				THEN
					...
					!
					TEMP_FLAG%, PR_MAIN_TRN_TK02_DED = 1%
