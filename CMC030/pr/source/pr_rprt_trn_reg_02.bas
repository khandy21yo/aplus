1	%TITLE "Payroll Register Report"
	...
	!	.b
	!	.lm +5
	!	The ^*Payroll Register\* report prints a
	...
	!
	! Index:
	!	.x Payroll Register>Report
	!	.x Report>Payroll Register
	!
	! Option:
	!
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_RPRT_TRN_REG_02/LINE
	!	$ LINK/EXECUTABLE=PR_EXE: PR_RPRT_TRN_REG_02, FUNC_LIB:CMCLINK/OPTION
	...
	!		Removed units from report for Coastal Group.
	!
	!	05/23/89 - Kevin Handy
	!		Taken from PR_RPRT_TRN_REG
	!
