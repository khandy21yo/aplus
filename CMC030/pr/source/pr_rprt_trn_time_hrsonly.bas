1	%TITLE "Payroll Time/Unit Report"
	%SBTTL "PR_RPRT_TRN_TIME_HRSONLY"
	%IDENT "V3.6a Calico"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_RPRT_TRN_TIME_HRSONLY/LINE
	!	$ LINK/EXECUTABLE=PR_EXE: PR_RPRT_TRN_TIME_HRSONLY, FUNC_LIB:CMCLINK/OPTION
