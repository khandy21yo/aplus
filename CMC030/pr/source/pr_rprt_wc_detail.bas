1	%TITLE "Payroll Workman Compensation Summary Report"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_RPRT_WC_DETAIL/LINE
	!	$ LINK/EXECUTABLE=PR_EXE: PR_RPRT_WC_DETAIL, FUNC_LIB:CMCLINK/OPTION
	!	$ DELETE PR_RPRT_WC_DETAIL.OBJ;*
	!
	! Author:
	!
	!	11/15/99 - Kevin Handy
	!		Based on PR_RPRT_WC_SUMMARY
	!
...
17710	SUM = 0.0
 ...
 EmpTotal:
	...
	WHEN ERROR IN
		GET #PR_EMP_MASTER.CH%, &
			KEY #0% EQ WORK_EMPNUM$, &
			REGARDLESS
	USE
		PR_EMP_MASTER::EMPNUM = WORK_EMPNUM$
		PR_EMP_MASTER::EMPNAME = ""

		CONTINUE 17890 IF ERR = 155%
		FILENAME$ = "PR_EMP_MASTER"
		CONTINUE HelpError
	END WHEN
