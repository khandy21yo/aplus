1	%TITLE "Payroll Direct Deposit Routine"
	%SBTTL "PR_SPEC_DIRECTDEPOSIT_02"
	%IDENT "V3.6a Calico"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_SPEC_DIRECTDEPOSIT_02/LINE
	!	$ LINK/EXECUTABLE=PR_EXE: PR_SPEC_DIRECTDEPOSIT_02, FUNC_LIB:CMCLINK/OPTION
	!	$ DELETE PR_SPEC_DIRECTDEPOSIT_02.OBJ;*
	!
	! Author:
	!
	!	06/01/98 - Kevin Handy
	!		Based upon PR_SPEC_DIRECTDEPOSIT
	!
...
17000	!******************************************************************
	...
	ACH_FILEHEADER::DESTINATION	= BANKCODE$
	ACH_FILEHEADER::ORIGIN		= "1" + ACCTCODE$
...
17100	!
 ...
 ExitTotal:
	...
	ACH_COMPANYBATCH::CID		= "1" + ACCTCODE$
