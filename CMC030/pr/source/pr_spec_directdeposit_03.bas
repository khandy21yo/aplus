1	%TITLE "Payroll Direct Deposit Routine"
	%SBTTL "PR_SPEC_DIRECTDEPOSIT_03"
	%IDENT "V3.6a Calico"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_SPEC_DIRECTDEPOSIT_03/LINE
	!	$ LINK/EXECUTABLE=PR_EXE: PR_SPEC_DIRECTDEPOSIT_03, FUNC_LIB:CMCLINK/OPTION
...
305	!
	...
	WHEN ERROR IN
		...
		ONAME$ = EDIT$(UTL_LOCATION::LOCNAME, 32%)
	USE
		ONAME$ = ""
	END WHEN
	...
	WHEN ERROR IN
		...
		CNAME$ = EDIT$(UTL_LOCATION::LOCNAME, 32%)
	USE
		CNAME$ = ONAME$
	END WHEN
...
17000	!******************************************************************
	...
	ACH_FILEHEADER::DNAME		= "FEDERAL RESERVE BANK"
	ACH_FILEHEADER::ONAME		= "BANK OF COMMERCE"
