1	%TITLE "Payroll W2 Tape Process"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_SPEC_TAXFLOPPY_2001
	...
	! Author:
	!
	!	01/16/2001 - Kevin Handy
	!		Taken from PR_SPEC_TAXTAPE and modified
	!		for completely changed format
	!
	! Modification history:
	!
	!	04/17/2003 - Kevin Handy
	!		Fix RT:NQP457 bug
	!--
	%PAGE
