1	%TITLE "Payroll W2 Tape Process"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_SPEC_TAXFLOPPY_2004
	...
	! Author:
	!
	!	01/05/2005 - Kevin Handy
	!		Taken from PR_SPEC_TAXTAPE_2001 and modified
	!		for completely format
	!
