1	%TITLE "Payroll W2 Tape Process"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_SPEC_TAXFLOPPY_2006
	...
	!		Taken from PR_SPEC_TAXFLOPPY_2005 and modified
	!		for new format
	!
...
2990	GOTO 2010
 ...
 !		CODE_RW::SUFFIX		= ""
		...
		CODE_RW::DRCS		= FUNC_REFORMAT(0.0, &
			LEN(CODE_RW::DRCS), 2%)
		CODE_RW::DRCSRA		= FUNC_REFORMAT(0.0, &
			LEN(CODE_RW::DRCSRA), 2%)
		CODE_RW::SEC		= "0"
 ...
 !			CODE_RS::SUFFIX		= ""
	...
	CASE "T"
		...
		CODE_RT::DRCS		= FUNC_REFORMAT(0.0, &
			LEN(CODE_RT::DRCS), 2%)
		CODE_RT::DRCSRA		= FUNC_REFORMAT(0.0, &
			LEN(CODE_RT::DRCSRA), 2%)
