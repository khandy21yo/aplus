1	%TITLE "BLANK - Blank Checks Numbers"
	...
	! Compile:
	!
	!	$ BAS PR_SOURCE:PR_SPEC_ZORCHCHECKhis
	...
	! Author:
	!
	!	04/21/2004 - Kevin Handy
	!		Based on PR_SPEC_ZORCHCHECK
	!
...
550	GOTO 600 IF (PR_HIS_CHECK::CHECK <> "      ")

	!
	! Replace the check record
	!
	WHEN ERROR IN
		DELETE #PR_HIS_CHECK.CH%
	USE
		CONTINUE ExitProgram IF ERR = 155%
		FILENAME$ = "PR_HIS_CHECK"
		CONTINUE HelpError
