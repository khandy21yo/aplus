1	%TITLE "Maintenance Sales Controlling File"
	%SBTTL "SA_MAIN_CONTROL"
	%IDENT "V3.6a Calico"

	FUNCTION LONG SA_MAIN_CONTROL(CDD_WINDOW_CDD SMG_WINDOW, LONG MOPTION, &
	...
	! Compile:
	!
	!	$ BAS SA_SOURCE:SA_MAIN_CONTROL/LINE
	...
	CASE OPT_INIT
		...
		! Define SMG_WINDOW
		!
		SMG_WINDOW::DESCR = "Sales Controlling File"
		SMG_WINDOW::NHELP = "SA_MAIN_CONTROL"
		SMG_WINDOW::HSIZE = 78%
		SMG_WINDOW::VSIZE = 18%
		SMG_WINDOW::HPOS  = 2%
		SMG_WINDOW::VPOS  = 2%
...
790		SMG_WINDOW::CHAN  = SB_CONTROL.CH%
	...
	!	which relate to the Sales Analysis System.
	!	.lm -5
	!
	! Index:
	!	.x Accounts>SA
...
20200	CASE OPT_ENTRY
 ...
 ReEnter:	SCOPE::SCOPE_EXIT = 0%
	...
	!	.b
	!	.lm +5
	!	The ^*Current Period\* field contains the period which
	!	indicates where the system is at the present time.
	!	.lm -5
	!
	! Index:
	!	.x Current Period
	...
	CASE OPT_FIND
		...
		CASE 0%
			FIND #SMG_WINDOW::CHAN, &
				KEY #0% GE SB_CONTROL::SYSTEM + "", REGARDLESS
