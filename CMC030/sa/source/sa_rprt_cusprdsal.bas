1	%TITLE "Sales by Customer and Product"
	...
	! Compile:
	!
	!	$ BAS SA_SOURCE:SA_RPRT_CUSPRDSAL/LINE
	...
	! Author:
	!
	!	01/07/92 - Dan Perkins
	!
	! Modification history:
	!
	!	01/20/92 - Dan Perkins
	!		Offset Grand Total output to make large
	...
	!		Modified to include information even if the salesman
	!		(subaccount) is undefined.
	!
	...
	!		Changed WILDCARD to PRDTYPWILDCARD (LL)
	!
 ...
 Initialization:
	...
	WLDCRD$ = ""
	PRDTYPWLDCRD$ = EDIT$(UTL_REPORTX::OPTDEF(3%), -1%)
	...
	!	shows the unit quantity on the report.
	!	.lm -5
	!
	! Index:
	!
	...
	!	.b
	!	.lm +5
	!	The ^*Number of Years\* field enters the
...
17500	V% = PD_EXAM_PRODUCT(LAST_PRODUCT$, PD_PRODUCT_EXAM)
 ...
 !	GOTO 17590 IF COMP_STRING(EDIT$( &
 !		PD_PRODUCT_EXAM::PROD_TYPE, -1%), PRDTYPWLDCRD$) = 0% &
 !		AND PRDTYPWLDCRD$ <> ""
...
32767	!******************************************************************
	! End of report SA_RPRT_CUSPRDSAL
	!******************************************************************
	END
