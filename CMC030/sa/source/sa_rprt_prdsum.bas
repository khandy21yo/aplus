1	%TITLE "Sales Summary by Product"
	...
	! Compile:
	!
	!	$ BAS SA_SOURCE:SA_RPRT_PRDSUM/LINE
 ...
 Initialization:
	...
	!	^*(06) Grand Total Only\*
	!	.p
	!	The ^*Grand Total Only\* field optionally
	!	shows only the last page containing
	...
	!	selects the fiscal year to will begin with.
	!
	! Index:
	!
	!--
