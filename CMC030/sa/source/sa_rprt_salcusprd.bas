1	%TITLE "Sales by Salesman and Customer"
	%SBTTL "SA_RPRT_SALCUSPRD"
	%IDENT "V3.6a Calico"
	...
	! Abstract:HELP
	!	.p
	!	The ^*Sales by Salesman and Customer Report\* option
	...
	! Compile:
	!
	!	$ BAS SA_SOURCE:SA_RPRT_SALCUSPRD/LINE
	...
	! Author:
	!
	!	12/31/91 - Dan Perkins
	!
	! Modification history:
	!
	!	01/05/92 - Frank F. Starman
	!		Add option to print more then one year of the
	!	sales history.
	!
 ...
 Initialization:
	...
	!	^*(01) Sort by (S,C,T)\*
	!	.p
	!	The ^*Sort by\* field will determine the order
	!	to print in.
	!	.p
	!	Valid settings are:
	!	.b
	...
	!	selects the fiscal year that the report will begin with.
	!
	! Index:
	!
	!--
 ...
 TestKey:
	...
	FOR Y% = 1% TO YEARS%
		...
		IF TEST_LINE$ <> IC_HISTORY(Y%)::SUBACCT  + &
			...
			TEST_LINE$ <> ""
		THEN
			CUST_TEST% = CUST_TEST% AND &
				(IC_HISTORY(Y%)::CROSSREF <> LAST_CROSSREF$)
...
17135	NEXT Y%
 ...
 PrintLine:
	IF LAST_CROSSREF$ <> SPACE$(LEN(AR_35CUSTOM_EXAM::CUSNUM))
	THEN
...
32767	!******************************************************************
	! End of report SA_RPRT_SALCUSPRD
	!******************************************************************
	END
