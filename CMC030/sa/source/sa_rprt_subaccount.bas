1	%TITLE "Sub Ledger Sub Account Report"
	...
	! Compile:
	!
	!	$ BAS SA_SOURCE:SA_RPRT_SUBACCOUNT/LINE
 ...
 Initialization:
	...
	!	^*(03) To Item\*
	!	.p
	!	The ^*To Item\* field specifies the order
...
300	!
 ...
 ReportTitle:
	...
	! Heading
	!
	TITLE$(4%) = "Sb Subaccount Description                    Ty Clas OnsetDate  S TermDate"
	TITLE$(5%) = ""
...
32767	!******************************************************************
	! End of report SA_RPRT_SUBACCOUNT
	!******************************************************************
	END
