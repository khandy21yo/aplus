1	%TITLE "Sub Account Account Maintenance"
	%SBTTL "SB_MAIN_ACCOUNT"
	%IDENT "V3.6a Calico"

	FUNCTION LONG SB_MAIN_ACCOUNT(CDD_WINDOW_CDD SMG_WINDOW, LONG MOPTION, &
	...
	! Compile:
	!
	!	$ BAS SB_SOURCE:SB_MAIN_ACCOUNT/LINE
	...
	CASE OPT_INIT
		...
		! Define SMG_WINDOW
		!
		SMG_WINDOW::DESCR = "Account Description"
		SMG_WINDOW::NHELP = "SB_MAIN_ACCOUNT"
		SMG_WINDOW::HSIZE = 76%
		SMG_WINDOW::VSIZE = 18%
		SMG_WINDOW::HPOS  = 2%
		SMG_WINDOW::VPOS  = 2%
...
20200	CASE OPT_ENTRY
 ...
 ReEnter:	SCOPE::SCOPE_EXIT = 0%
	...
	!	for entry a number which
	!	will reference the system to a General Ledger Account.
	!	.p
	!	The field will accommodate eightteen (18) alphanumeric
	!	characters.
...
20300	CASE OPT_TESTENTRY
		...
		CASE 1%
			...
			SMG_STATUS% = SMG$PUT_CHARS(SMG_WINDOW::WNUMBER, &
				GL_CHART::DESCR, 5%, 46%, , SMG$M_BOLD)
