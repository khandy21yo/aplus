DEFINE RECORD CDD$TOP.UTL.UTL_MASTER_REPORT

        DESCRIPTION IS /*CMC: Version of UTL_REPORT File*/.

        UTL_MASTER_REPORT_CDD STRUCTURE.
        ...
        END UTL_MASTER_REPORT_CDD STRUCTURE.

END UTL_MASTER_REPORT.
